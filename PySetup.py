...
script = "escape.py"   # Starting .py or .pyw script
dest_file = "WikiGame"  # Final name of .exe file
dest_folder = "WikiGame"   # Final folder to contain the executable, data files, etc.
icon_file = "images\\gameicon.png"       # Icon file. Leave blank for the pygame icon.
extra_data = ['images', 'fonts']              # Extra data to copy to the final folder
...
lib_excludes = ["Tkinter", "tcl", "Numeric", "numpy", "wxPython", "pyglet"]
